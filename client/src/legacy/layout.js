/* ============================================================
   ...
   Ported from client/scripts/layout.js. Instead of running on
   DOMContentLoaded (which doesn't fire again for client-side
   route changes), this module exports initLayout() which the
   Layout.jsx component calls from a useEffect on mount, and
   updateCartBadges() which other legacy modules import directly
   instead of relying on a `typeof updateCartBadges === 'function'`
   global check like the original vanilla script did.
   ============================================================ */

import { getUser as authGetUser, logout as authLogout } from './auth.js';

/* ── Auth helpers (kept local, same as original layout.js) ── */
    ...
    return /* html */`
        <div class="dropdown" id="profileDropdown">
            ...
            <ul class="dropdown__menu" id="profileMenu" role="menu">
                ...
                <li role="none">
                    <a href="/account#my-orders" role="menuitem">
...
function buildGuestHTML() {
    return /* html */`
        <div class="nav__auth-links">
            <a class="nav__btn-solid" href="/login">Sign In</a>
        </div>
    `;
}
    ...
    return /* html */`
        ...
        <nav class="nav" role="navigation" aria-label="Main navigation">
            ...
            <div class="nav--desktop container">
                ...
                <a class="nav__logo" href="/" aria-label="Craftora – go to homepage">
                ...
                <div class="nav__actions">
                    ...
                    <a href="/wishlist" class="nav__icon-btn" aria-label="View wishlist">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <a href="/cart" class="nav__icon-btn" aria-label="View cart">
                        ${CART_SVG}
            ...
            <div class="nav__phone">
                ...
                <a class="nav__phone-logo" href="/" aria-label="Craftora – go to homepage">
                    <img width="116" height="26" src="/assets/logo.webp" alt="Craftora">
                </a>
...
<footer class="footer">
    <div class="footer-top container">
        <div class="footer-brand">
            <a href="/" aria-label="Craftora Home">
        ...
        <div class="footer-links">
            <h3>Shop</h3>
            <ul>
                <li><a href="/products?category=Diary">Diary</a></li>
                <li><a href="/products?category=Bottle">Bottle</a></li>
                <li><a href="/products?category=Tshirt">T-shirt</a></li>
                <li><a href="/products?category=Cup">Cup</a></li>
            </ul>
        </div>
        <div class="footer-links">
            <h3>Account</h3>
    ...
    function renderResults(dropdown, query) {
        ...
        if (filtered.length === 0) {
            ...
            dropdown.innerHTML = filtered.map((p, i) => {
                ...
                return `<a class="search-dd__item" href="/product?id=${encodeURIComponent(p.id)}" role="option" data-index="${i}">
...
/* ══════════════════════════════════════════════════════════
   INIT — called by Layout.jsx from useEffect on mount
══════════════════════════════════════════════════════════ */
