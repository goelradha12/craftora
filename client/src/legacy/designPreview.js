/**
 * designPreview.js — Craftora Design Preview
 * Ported from client/scripts/design_preview.js almost verbatim.
...
export const DesignPreview = (() => {
      ...
      <div id="dp-card">
        ...
        <div id="dp-image-wrap">
          ...
          <div class="dp-image-col">
            <span class="dp-image-label" id="dp-image-label-front" style="display:none;">Front</span>
            <img id="dp-image" alt="Design preview — front" style="display:none;" />
          </div>
          <div class="dp-image-col" id="dp-image-back-col" style="display:none;">
            <span class="dp-image-label">Back</span>
            <img id="dp-image-back" alt="Design preview — back" />
          </div>
        </div>
        <div id="dp-footer">
  ...
  function populate(data, productId) {
    ...
    const imgBack = document.getElementById('dp-image-back');
    const frontLabel = document.getElementById('dp-image-label-front');
    const backCol = document.getElementById('dp-image-back-col');
    ...
    if (data.previewImage && data.previewImageBack) {
      frontLabel.style.display = 'block';
      imgBack.src = data.previewImageBack;
      backCol.style.display = 'flex';
    } else {
    ...
    const customizeUrl = `/customize${productId ? `?id=${productId}` : ''}`;
  ...
  function showCartCustomization(cartItemKey) {
    ...
    populate({
      ...
      previewImageBack: customization.previewImageBack
    }, item.id);
