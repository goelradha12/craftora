/* ============================================================
   index.js — Craftora Home Page
   Ported from client/scripts/index.js, exported as ESM.
   ============================================================ */
...
/* ══════════════════════════════════════════════════════════
   ...
   (present in the current markup only as static image grid,
   kept defensive with the same null-checks as the original)
══════════════════════════════════════════════════════════ */
    ...
    try {
        ...
        cards.forEach((card, i) => {
            card.addEventListener('click', (e) => {
                ...
                if (product) window.location.href = `/product?id=${encodeURIComponent(product.id)}`;
            });
        });
